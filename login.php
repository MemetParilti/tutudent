...
<body>
  ...
  <main class="auth auth-floated">
    ...
    <form class="auth-form" action="">
      <div class="mb-4">
        ...
        <h1 class="h3">Student Sign In </h1>
      </div>
      <!-- <p class="text-left mb-4"> Don't have a account? <a href="auth-signup.html">Create One</a>-->
      </p><!-- .form-group -->
      <p class="text-left mb-4"> teacher sign in ? <a href="login_teacher.php">sign in now</a>
  ...
  <script>
    ...
    function login() {
      ...
      if (un != "" && ps != "") {
        formData.append('op', 'login_student');
        ...
        xhr.onload = function () {
          ...
          if (loginResult == 1) {
           ...
           window.location=('studentDashboard.php?name=' + data['name'] + '&id='+data['id']);
